        	...
        	<div class="row">
            	<div class="col-lg-12 pm-columnPadding30 pm-center">
                    ...
                    <div class="pm-column-title-divider">
               	    	<img src="<?php echo base_url().'assets/themes/medicallink/'?>img/divider-icon.png" width="29" height="29" alt="icon">
                    </div>
        	...
        	<div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <article class="pm-column-spacing wow fadeInUp animated" data-wow-delay="0.6s" data-wow-offset="50" data-wow-duration="1s">
                    	...
                    	<div class="pm-standalone-news-post" style="background-image:url(<?php echo base_url().'assets/themes/medicallink/'?>img/home/news-post2.jpg);">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <article class="pm-column-spacing wow fadeInUp animated" data-wow-delay="0.9s" data-wow-offset="50" data-wow-duration="1s">
                    	...
                    	<div class="pm-standalone-news-post" style="background-image:url(<?php echo base_url().'assets/themes/medicallink/'?>img/home/news-post3.jpg);">
