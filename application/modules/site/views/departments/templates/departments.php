<!DOCTYPE html>
<html lang="en">
  <?php echo $this->load->view('site/departments/includes/header', '', TRUE);?>
  <body>
	<div id="pm_layout_wrapper" class="pm-full-mode"><!-- Use wrapper for wide or boxed mode -->
        ...
        <?php 
             $title_name = NULL;
             $data['title'] = NULL;
             $data['ultra_mini_title'] = NULL;
             $data['department_name'] = NULL;
             echo $this->load->view('site/departments/includes/sub_header', $data , TRUE);?>
